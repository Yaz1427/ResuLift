        ...
        <Card key={i} className="border-border/50">
          ...
          <CardContent className="space-y-3">
            <div className="bg-muted/30 rounded-lg p-3 border border-border/30">
              <p className="text-xs font-medium text-muted-foreground mb-1">Version originale</p>
            ...
            <div className="bg-violet-500/5 rounded-lg p-3 border border-violet-500/20">
              <p className="text-xs font-medium text-violet-400 mb-1">Version optimisée</p>
              <p className="text-sm leading-relaxed">{bullet.optimized}</p>
            </div>
            {bullet.reasoning && (
              <>
                <Separator />
                <p className="text-xs text-muted-foreground"><span className="font-medium">Pourquoi : </span>{bullet.reasoning}</p>
              </>
            )}
          </CardContent>
        </Card>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-2">
                  <span className="font-medium text-foreground">Où l&apos;ajouter : </span>
                  {s.suggestedPlacement}
                </p>
                <div className="bg-muted/30 rounded-lg p-2 border border-border/30">
                  <p className="text-xs text-muted-foreground">
                    <span className="font-medium">Exemple : </span>{s.exampleUsage}
                  </p>
                </div>
              </div>
            </div>
